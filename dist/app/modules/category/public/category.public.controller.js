...
exports.categoryPublicController = void 0;
const http_status_1 = __importDefault(require("http-status"));
const catchAsync_1 = __importDefault(require("../../../utils/catchAsync"));
const AppError_1 = __importDefault(require("../../../error/AppError"));
const sendResponse_1 = __importDefault(require("../../../utils/sendResponse"));
const category_public_service_1 = require("./category.public.service");
const getAllPublicCategory = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const query = req.query;
    if (!query)
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "Category not Found");
    const result = yield category_public_service_1.CategoryPublicService.getAllPublicCategoryIntoDB(query);
